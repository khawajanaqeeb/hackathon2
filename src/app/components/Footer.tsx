export default function Footer() {
  return (
    <div className="w-[1440px] h-[505px] mt-[4330px]">
      <div className="w-[1240px] h-[419px] pt-[48px] ml-[100px] bg-[#FFFFFF]  ">
        <div className="flex justify-evenly">
          <div>
          <h2 className="w-[85px] h-[36px] mt-[48px] ml-[100px] font-[Poopins] font-[700] text-2xl ">
            Funiro.
          </h2>
          <p className="w-[285px] h-[72px] mt-[10%] ml-[102.01px] text-[#9F9F9F] font-[Poppins] font-normal gap-2">
